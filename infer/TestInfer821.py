...
def read_image(file, target_spacing, has_reverse = True):
...
def infer_step(input_path, output_path, predictor916, predictor821):
    ...
    img, props, is_reverse = read_image(input_path, infer_spacing, has_reverse = True)
    ...
    out_np = seg_by_water(ret916_np, ret821_np, watershed_np, is_mirror_pulp = False)
    output_path = output_path.replace("_0000.nii.gz", ".nii.gz")
