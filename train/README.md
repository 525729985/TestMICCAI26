...
DatasetX16: The instance branch functions to generate object contours.
DatasetX21: The semantic branch aggregates teeth id within the instance regions.
...
```bash
nnUNetv2_extract_fingerprint -d 1221
nnUNetv2_plan_experiment -d 1221
nnUNetv2_preprocess -d 1221 -c 3d_new
nnUNetv2_train 1221 3d_new 0 --c -tr nnUNetTrainer_DASegOrd0_NoMirroring
```
